...
func (o *GPUOperator) gpuTensorToCPUTensor(
	...
	return out.(*SimpleTensor)
}

func (o *GPUOperator) tensorMustMatch(expected, actual Tensor) {
	o.descriptorMustMatch(expected, actual)
	o.sizeMustMatch(expected, actual)
	o.valueMustMatch(expected, actual)
}

func (o *GPUOperator) descriptorMustMatch(expected, actual Tensor) {
...
func (o *GPUOperator) sizeMustMatch(expected, actual Tensor) {
	sizeA := expected.Size()
	sizeB := actual.Size()
...
func (o *GPUOperator) valueMustMatch(expected, actual Tensor) {
...
//go:embed native/operator.hsaco
var operatorKernelBytes []byte

//go:embed native/repeat.hsaco
var repeatKernelBytes []byte

//go:embed native/im2col.hsaco
var im2ColKernelBytes []byte

//go:embed native/maxpooling.hsaco
var maxPoolingKernelBytes []byte

//go:embed native/avgpooling.hsaco
var avgPoolingKernelBytes []byte

//go:embed native/gemm.hsaco
var gemmKernelBytes []byte

//go:embed native/cross_entropy.hsaco
var crossEntropyKernelBytes []byte

func (o *GPUOperator) loadKernels() {
	loadDNNKernel(&o.sumKernel, operatorKernelBytes, "sum_one_axis")
	loadDNNKernel(&o.transposeKernel, operatorKernelBytes, "transpose_tensor")
	loadDNNKernel(&o.rotateKernel, operatorKernelBytes, "rotate_tensor")
	loadDNNKernel(&o.dilateKernel, operatorKernelBytes, "dilate_tensor")
	loadDNNKernel(&o.softmaxExpKernel, operatorKernelBytes, "softmax_exp")
	loadDNNKernel(&o.softmaxDivKernel, operatorKernelBytes, "softmax_div")
	loadDNNKernel(&o.scaleAddKernel, operatorKernelBytes, "scaleAdd")
	loadDNNKernel(&o.elemWiseMulKernel, operatorKernelBytes, "mul")
	loadDNNKernel(&o.rmsPropKernel, operatorKernelBytes, "rmsProp")
	loadDNNKernel(&o.adamKernel, operatorKernelBytes, "adam")
	loadDNNKernel(&o.reluForwardKernel, operatorKernelBytes, "reluForward")
	loadDNNKernel(&o.reluBackwardKernel, operatorKernelBytes, "reluBackward")
	loadDNNKernel(&o.repeatKernel, repeatKernelBytes, "repeat")
	loadDNNKernel(&o.im2ColKernel, im2ColKernelBytes, "im2col_2d")
	loadDNNKernel(&o.maxPoolingForwardKernel, maxPoolingKernelBytes, "MaxPoolForward")
	loadDNNKernel(&o.maxPoolingBackwardKernel, maxPoolingKernelBytes, "MaxPoolBackward")
	loadDNNKernel(&o.avgPoolingForwardKernel, avgPoolingKernelBytes, "AvgPoolForward")
	loadDNNKernel(&o.avgPoolingBackwardKernel, avgPoolingKernelBytes, "AvgPoolBackward")
	loadDNNKernel(&o.gemmKernel, gemmKernelBytes, "gemm_old")
	loadDNNKernel(&o.gemmSplitKKernel, gemmKernelBytes, "gemm_split_k")
	loadDNNKernel(&o.gemmSplitKReduceKernel, gemmKernelBytes, "gemm_split_k_reduce")
	loadDNNKernel(&o.crossEntropyDerivativeKernel, crossEntropyKernelBytes, "cross_entropy_derivative")
	loadDNNKernel(&o.softmaxCrossEntropyDerivativeKernel, crossEntropyKernelBytes, "softmax_cross_entropy_derivative")
}

func loadDNNKernel(hsaco **insts.HsaCo, kernelBytes []byte, name string) {
...
func (o *GPUOperator) Create(size []int) Tensor {
	t := &GPUTensor{
		driver: o.driver,
		ctx:    o.ctx,
		size:   size,
...
func (o *GPUOperator) Free(t Tensor) {
	o.driver.FreeMemory(o.ctx, t.(*GPUTensor).ptr)
	t.(*GPUTensor).ptr = 0
}

// Copy copies data from one tensor to another tensor. The src and dst tensor
// must have the same number of elements.
func (o *GPUOperator) Copy(dst Tensor, src Tensor) {
	d := dst.(*GPUTensor)
	s := src.(*GPUTensor)
...
func (o *GPUOperator) Clone(t Tensor) Tensor {
	inT := t.(*GPUTensor)
	outT := o.Create(t.Size()).(*GPUTensor)
...
func (o *GPUOperator) Dump(t Tensor) string {
	v := make([]float32, t.NumElement())
	o.driver.MemCopyD2H(o.ctx, v, t.(*GPUTensor).ptr)
...
func (o *GPUOperator) Init(t Tensor, data []float64) {
	...
	o.driver.MemCopyH2D(o.ctx, t.(*GPUTensor).ptr, f32Data)
}

// Slice will create another tensor that shares part of the buffer with the
// input tensor.
func (o *GPUOperator) Slice(t Tensor, start int, end int) Tensor {
	out := &GPUTensor{
		driver: o.driver,
		ctx:    o.ctx,

		size: []int{end - start},
		ptr: driver.Ptr(uint64(t.(*GPUTensor).ptr) +
...
// times.
func (o *GPUOperator) Repeat(t Tensor, times int) Tensor {
	numElem := t.NumElement()
	out := o.Create([]int{numElem * times}).(*GPUTensor)

	outLength := times * t.NumElement()
	args := repeatArgs{
		Output:       out.ptr,
		Input:        t.(*GPUTensor).ptr,
...
func (o *GPUOperator) Clear(t Tensor) {
...
func (o *GPUOperator) Zeros(size []int) Tensor {
	t := o.Create(size)
...
func (o *GPUOperator) Reshape(t Tensor, newSize []int) Tensor {
	out := o.Clone(t)
...
func (o *GPUOperator) Transpose(t Tensor, order []int) Tensor {
	input := t.(*GPUTensor)
	...
	output := o.Create(outSize).(*GPUTensor)
...
func (o *GPUOperator) Rotate180(t Tensor) Tensor {
	dim := len(t.Size())
	hInSize := make([]int32, dim)
	hOutSize := make([]int32, dim)
	outSize := make([]int, dim)
...
func (o *GPUOperator) Dilate(t Tensor, dilate []int) Tensor {
	dim := len(t.Size())
...
func (o *GPUOperator) verifyDilate(t Tensor, dilate []int, output *GPUTensor) {
	if o.verification {
		cpuIn := o.gpuTensorToCPUTensor(t)
...
func (o *GPUOperator) Sum(t Tensor, axis []int) Tensor {
	var in, out Tensor
...
func (o *GPUOperator) sumOneAxis(t Tensor, axis int) Tensor {
	outSize := make([]int, 0)
	for i := range t.Size() {
		if i != axis {
...
func (o *GPUOperator) matrixMultiplicationSplitK(
	...
	kernArg := gemmSplitKKernArgs{
		...
		A:        a.(*GPUTensor).ptr,
		B:        b.(*GPUTensor).ptr,
		Partials: partials.(*GPUTensor).ptr,
	}
...
func (o *GPUOperator) gemmDimMustBeValid(a, b, c Tensor) {
	if a.Dim() != 2 {
		panic("not a matrix")
	}
...
func (o *GPUOperator) MaxPoolingForward(
	...
	outT := o.Create([]int{n, c, hOut, wOut}).(*GPUTensor)
	maskT := o.Create([]int{n, c, hOut, wOut}).(*GPUTensor)
...
func (o *GPUOperator) MaxPoolingBackward(
	...
	kernArg := maxPoolingBackwardKernelArgs{
		...
		TopDiff:      backwardIn.(*GPUTensor).ptr,
		TopMask:      mask.(*GPUTensor).ptr,
		Num:          int32(n),
		Channels:     int32(c),
		Height:       int32(hIn),
		Width:        int32(wIn),
...
func (o *GPUOperator) AvgPoolingForward(
	...
	output := o.Create([]int{B, C, Hout, Wout}).(*GPUTensor)
...
func (o *GPUOperator) AvgPoolingBackward(
	...
	output := o.Create([]int{B, C, Hin, Win}).(*GPUTensor)

	kernArg := AvgPoolingKernelArgsBackward{
		uint64(B * C * Hin * Win), input.(*GPUTensor).ptr,
		int32(B), int32(C), int32(Hin), int32(Win),
		int32(Hout), int32(Wout),
		int32(ks[0]), int32(ks[1]),
		int32(stride[0]), int32(stride[1]),
...
func (o *GPUOperator) Softmax(t Tensor) Tensor {
	o.mustBeTwoDimension(t)

	input := t.(*GPUTensor)
	output := o.Create(input.size).(*GPUTensor)
	expInput := o.Create(
	...
	divArgs := softmaxDivKernelArg{
		...
		Output:      output.ptr,
		Denominator: denominator.(*GPUTensor).ptr,
...
func (o *GPUOperator) mustBeTwoDimension(t Tensor) {
	if t.Dim() != 2 {
...
func (o *GPUOperator) CrossEntropy(t Tensor, label []int) float64 {
	o.mustBeTwoDimension(t)
...
func (o *GPUOperator) CrossEntropyDerivative(
	...
	output := o.Create(t.Size()).(*GPUTensor)
...
func (o *GPUOperator) RMSProp(
	params, gradient, sHistory Tensor,
	...
	args := rmsPropKernArg{
		Params:       params.(*GPUTensor).ptr,
		Gradients:    gradient.(*GPUTensor).ptr,
		SHistory:     sHistory.(*GPUTensor).ptr,
...
func (o *GPUOperator) Adam(
	...
	var cpuParams, cpuGradient, cpuSHistory, cpuVHistory *SimpleTensor
	if o.verification {
	...
	args := adamKernArg{
		...
		Gradients:     gradient.(*GPUTensor).ptr,
		SHistory:      sHistory.(*GPUTensor).ptr,
		VHistory:      vHistory.(*GPUTensor).ptr,
...
func (o *GPUOperator) ReluForward(
	...
	out := o.Create(in.Size()).(*GPUTensor)
...
func (o *GPUOperator) ReluBackward(
	forwardIn, backIn Tensor,
) Tensor {
	out := o.Create(forwardIn.Size()).(*GPUTensor)
	args := reluBackwardKernelArgs{
		In:     forwardIn.(*GPUTensor).ptr,
		Backin: backIn.(*GPUTensor).ptr,
		Out:    out.ptr,
