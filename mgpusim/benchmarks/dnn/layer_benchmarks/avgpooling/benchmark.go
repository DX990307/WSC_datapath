// Package avgpooling defines a benchmark for the average-pooling layer.
package avgpooling
...
// Benchmark is a benchmark for the average-pooling layer.
...
// NewBenchmark creates a new average-pooling benchmark.
...
func (b *Benchmark) SelectGPU(gpus []int) {
	if len(gpus) > 1 {
		panic("AvgPooling benchmark can only run on a single GPU for now.")
	}
