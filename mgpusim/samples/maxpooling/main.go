...
var padX = flag.Int("pad-x", 0, "padding on the x axis")
var padY = flag.Int("pad-y", 0, "padding on the y axis")
var strideX = flag.Int("stride-x", 1, "stride on the x axis")
var strideY = flag.Int("stride-y", 1, "stride on the y axis")
