...
import (
	...
	//"github.com/sarchlab/mgpusim/v3/virtualdevice/virtualtlb"
	"fmt"
	"github.com/sarchlab/akita/v3/mem/vm"
	"github.com/sarchlab/akita/v3/sim"
	"github.com/sarchlab/mgpusim/v3/virtualdevice"
	"github.com/sarchlab/mgpusim/v3/virtualdevice/virtualcache"
	"log"
	//"os"
	"math"
	"reflect"
...
func (vc *VirtualCU) IntervalModel(req *virtualdevice.Request) (sim.VTimeInSec, bool) {
	...
	for idx := inst_idx; (idx < len(*inst_types)) && continue_execute; idx++ {
		...
		default:
			log.Panicf("Inst format %v is not supported", inst_type)
		}
